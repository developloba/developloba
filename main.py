...
from tkinter import messagebox, DISABLED, NORMAL, RIGHT, LEFT, TOP, BOTTOM
import pyrebase
...
header = Style()
header.configure('head.TLabel', font =('coolvetica rg', 50,),
                foreground = '#892CAA')
header = Style()
header.configure('bod.TLabel', font =
               ('coolvetica rg', 28,),
                foreground = '#892CAA')

body = Style()
body.configure('bodyy.TLabel', font =
               ('product sans', 20,),
                foreground = 'Black',)

body = Style()
body.configure('body2.TLabel', font =
               ('product sans', 100))

body = Style()
body.configure('body.TEntry', font =
               ('product sans', 20),
)
body = Style()
